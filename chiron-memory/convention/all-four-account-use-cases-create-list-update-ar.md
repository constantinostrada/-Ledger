...
type: convention
title: All four account use cases (Create/List/Update/Archive) share one `accountMapper` for Account entity → AccountDTO conversion instead of duplicating mapping logic per use case.
tags: [convention]
created: 2026-07-22

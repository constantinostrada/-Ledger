...
type: decision
title: Account.balance_cents column dropped from Postgres schema; balance is now computed as credits−debits via a Prisma groupBy aggregate over transactions in PrismaAccountRepository.
tags: [decision]
created: 2026-07-22

...
type: architecture
title: Domain Account.balance is a hydrated read-only snapshot populated by the repository from aggregated transactions, not an entity-owned/settable field; canDebit and insufficient-funds checks run against this true derived value.
tags: [architecture]
created: 2026-07-22
